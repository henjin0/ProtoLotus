...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.position)
        ...
        self.tabWidget.addTab(self.position, "")
        self.rotation = QtWidgets.QWidget()
        self.rotation.setObjectName("rotation")
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(self.rotation)
        self.verticalLayout_6.setObjectName("verticalLayout_6")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.rotationTableWidget = QtWidgets.QTableWidget(self.rotation)
        self.rotationTableWidget.setEnabled(True)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setStrikeOut(False)
        self.rotationTableWidget.setFont(font)
        self.rotationTableWidget.setRowCount(10)
        self.rotationTableWidget.setColumnCount(10)
        self.rotationTableWidget.setObjectName("rotationTableWidget")
        self.rotationTableWidget.horizontalHeader().setDefaultSectionSize(20)
        self.rotationTableWidget.horizontalHeader().setMinimumSectionSize(19)
        self.horizontalLayout_3.addWidget(self.rotationTableWidget)
        self.verticalLayout_6.addLayout(self.horizontalLayout_3)
        self.tabWidget.addTab(self.rotation, "")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.position), _translate("MainWindow", "position"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.rotation), _translate("MainWindow", "rotation"))
