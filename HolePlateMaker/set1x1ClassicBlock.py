...
def set1x1ClassicBlock(xPoint,yPoint,zPoint,filepath):
    ...
    if(filepath == "setting/blocks/1x1CBNS.stl"):
        your_mesh.translate(np.array([xPoint*7.986,yPoint*7.986,zPoint*4.8944 - 1.7/2])) # 4.8944=Stad*2/5(block height)
    else:
        your_mesh.translate(np.array([xPoint*7.986,yPoint*7.986,zPoint*4.8944])) # 4.8944=Stad*2/5(block height) + 1.7(Stad height)
